...
// in flutter_aws_cognito_access_iotcore_mqtt/test/src/data/repositories/mqtt_client_repository_impl_test.dart.
...
class _FakeMqttClientPayloadBuilder_1 extends _i1.SmartFake
    implements _i2.MqttClientPayloadBuilder {
  _FakeMqttClientPayloadBuilder_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
/// A class which mocks [MqttClientPayloadBuilder].
///
/// See the documentation for Mockito's code generation for more information.
class MockMqttClientPayloadBuilder extends _i1.Mock
    implements _i2.MqttClientPayloadBuilder {
  @override
  ...
  @override
  _i2.MqttClientPayloadBuilder addBuffer(_i6.Uint8Buffer? buffer) =>
      (super.noSuchMethod(
        Invocation.method(
          #addBuffer,
          [buffer],
        ),
        returnValue: _FakeMqttClientPayloadBuilder_1(
          this,
          Invocation.method(
            #addBuffer,
            [buffer],
        ...
        returnValueForMissingStub: _FakeMqttClientPayloadBuilder_1(
          this,
          Invocation.method(
            #addBuffer,
            [buffer],
      ...
      ) as _i2.MqttClientPayloadBuilder);

  @override
  _i2.MqttClientPayloadBuilder addByte(int? val) => (super.noSuchMethod(
        Invocation.method(
          #addByte,
          [val],
        ),
  ...
  @override
  _i2.MqttClientPayloadBuilder addBool({required bool? val}) =>
      (super.noSuchMethod(
        Invocation.method(
          #addBool,
          [],
  ...
  @override
  _i2.MqttClientPayloadBuilder addHalf(int? val) => (super.noSuchMethod(
        Invocation.method(
          #addHalf,
          [val],
        ),
  ...
  @override
  _i2.MqttClientPayloadBuilder addWord(int? val) => (super.noSuchMethod(
        Invocation.method(
          #addWord,
          [val],
        ),
  ...
  @override
  _i2.MqttClientPayloadBuilder addInt(int? val) => (super.noSuchMethod(
        Invocation.method(
          #addInt,
          [val],
        ),
  ...
  @override
  _i2.MqttClientPayloadBuilder addString(String? val) => (super.noSuchMethod(
        Invocation.method(
          #addString,
          [val],
        ),
  ...
  @override
  _i2.MqttClientPayloadBuilder addUTF16String(String? val) =>
      (super.noSuchMethod(
        Invocation.method(
          #addUTF16String,
          [val],
  ...
  @override
  _i2.MqttClientPayloadBuilder addUTF8String(String? val) =>
      (super.noSuchMethod(
        Invocation.method(
          #addUTF8String,
          [val],
  ...
  @override
  _i2.MqttClientPayloadBuilder addHalfDouble(double? val) =>
      (super.noSuchMethod(
        Invocation.method(
          #addHalfDouble,
          [val],
  ...
  @override
  _i2.MqttClientPayloadBuilder addDouble(double? val) => (super.noSuchMethod(
        Invocation.method(
          #addDouble,
          [val],
        ),
  ...
  @override
  _i2.MqttClientPayloadBuilder clear() => (super.noSuchMethod(
        Invocation.method(
          #clear,
          [],
        ),
